...
## Filtering the data relating to Norway, and greece The highest and lowest mortality in western europ
```{r}
...
## selecting the 3 highest and 3 lowest europian countries in terms of average containment index over the corona pendamic
```{r}
...
## Evaluating the containment measure vs number of cases and death in Greece, and Norway.
We will attempt to asses if the containment measures were implemented in response to Covid_19 waives or as preventive measure.


### Norway cases vs Containment
```{r}
...
# Step 4: Modeling Daily Cases Over the Years

## Visualizing Deaths Over Time with Linear Regression Line
...
## Visualizing Cases Over Time with Linear Regression Line
...
Before starting this study, I believed that stricter contingency measures would always lead to lower mortality rates. However, this belief turned out to be incorrect. Now that I've reviewed the results, I understand that numerous other factors play a role. Disease spread is a complex issue influenced by social factors, and predicting anything related to human behavior is extremely challenging.

# Step 6 Conclusion
The data showed that things are more complicated. It's not just about how strict the rules are. Other things like how many people got vaccinated, the ages of the population, and how the healthcare system works all play a part. It's like a big puzzle with many pieces. This makes it hard to predict how the disease will spread and how many people will die.

Another tricky part is that human behavior is a big factor. How people act, follow safety rules, and even how they go about their daily lives affects the disease. Predicting what people will do is really tough, like trying to find your way in a confusing maze. The study results have shown that because people act in unexpected ways, it's hard to make exact models.

In the end, this study taught me that while rules do matter, there's a lot more to consider. Everything happening around us, how people behave, and how society works all shape what happens with the disease. It's like a big mix of things, and understanding it all is quite a challenge.
